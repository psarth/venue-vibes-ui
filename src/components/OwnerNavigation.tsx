...
export default function OwnerNavigation() {
  ...
  const navItems = [
    ...
    { icon: '🏟️', label: 'My Venue', path: '/owner/venue' },
    { icon: '⏰', label: 'Slots', path: '/owner/slots' },
      ...
      {navItems.map(item => {
        ...
        return (
          <button
            ...
            className={`flex-1 flex flex-col items-center justify-center gap-1 py-2 px-1 rounded-lg transition-all ${isActive
